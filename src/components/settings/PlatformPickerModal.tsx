...
export function PlatformPickerModal({ onClose, onSelect }: PlatformPickerModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh]">
        {/* Header */}
        ...
        <div className="p-4 border-b border-zinc-800 space-y-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-10 pr-4 py-2 text-sm text-zinc-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {filteredPlatforms.map(platform => (
              <button
                ...
                className="bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700/50 hover:border-zinc-600 rounded-xl p-4 flex items-center gap-4 text-left transition-all"
              >
                 <div className="w-10 h-10 rounded-full bg-zinc-700 flex items-center justify-center shrink-0">
                    ...
                    <span className="font-bold text-lg text-white">{platform.name.charAt(0)}</span>
                 </div>
                 <div>
